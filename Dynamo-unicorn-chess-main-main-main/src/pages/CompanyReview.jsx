    ...
    <div className='relative h-screen mb-16'>
      <div className='banner'>
        <img
          ...
          src='https://www.liquiloans.com/images/bg-contactus.jpg'
          alt='Contact Us'
        />
            ...
            <form className='space-y-4' onSubmit={handleSubmit}>
              <div className='w-full flex flex-wrap'>
                <div className='w-1/2 max-sm:w-full px-2'>
                  <label htmlFor='name' className='block mb-2 text-sm font-medium text-slate-100'>
                    Your Name
                  </label>
                  <input
                    type='text'
              ...
              <div className='w-full flex flex-wrap'>
                ...
                <div className='w-1/2 max-sm:w-full px-2'>
                  <label htmlFor='subject' className='block mb-2 text-sm font-medium text-slate-100'>
                    Subject
                  </label>
                  <input
                    type='text'
              ...
              <div className='px-2'>
                <label htmlFor='message' className='block mb-2 text-sm font-medium text-slate-100'>
                  Your Message
                </label>
                <textarea
                  id='message'
